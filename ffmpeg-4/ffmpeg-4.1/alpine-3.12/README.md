# ffmpeg 4.1 alpine 3.12

## Running

```sh
docker run --rm sitkevij/ffmpeg:4.1-alpine-3.12
```

## Pulling from Docker Hub

```sh
docker pull sitkevij/ffmpeg:4.1-alpine-3.12
```
...
./build-local.sh sitkevij ffmpeg-4.0-alpine && \
docker run --rm sitkevij/ffmpeg:4.1-alpine-3.12
```
